            ...
            <Paper sx={{ p: 4, borderRadius: 3, boxShadow: 3, mb: 3 }}>
              ...
              <Stack spacing={3}>
                <Box display="flex" alignItems="center">
                  <Person sx={{ color: '#1A73E8', mr: 2 }} />
                  <Typography variant="body2" sx={{ color: '#7B809A', minWidth: 100 }}>
                    Employee ID:
                  </Typography>
                  {isEditing ? (
                    <TextField
                ...
                <Box display="flex" alignItems="center">
                  <CalendarToday sx={{ color: '#1A73E8', mr: 2 }} />
                  <Typography variant="body2" sx={{ color: '#7B809A', minWidth: 100 }}>
                    Idle From:
                  </Typography>
                  {isEditing ? (
                ...
                <Box display="flex" alignItems="center">
                  <AttachMoney sx={{ color: '#1A73E8', mr: 2 }} />
                  <Typography variant="body2" sx={{ color: '#7B809A', minWidth: 100 }}>
                    Rate:
                  </Typography>
                  {isEditing ? (
